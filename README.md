...
<div align= "center">
  <h4>Face mask detection system built with OpenCV, Keras/TensorFlow to detect face masks in static images as well as in real-time video streams using Deep Learning and Computer Vision concepts.</h4>
</div>
